...
public class CreateProjectPage {
	...
	private static final By btnProjNameNext = By.cssSelector("body > main > main > article.state.name.state-active.ng-scope > form > button"); 
	private static final By btnProjTypeNext = By.cssSelector("body > main > main > article.state.type.ng-scope.state-active > form > button"); 
